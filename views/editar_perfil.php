...
<section id="services">
  ...
  <div class="form-group">
    ...
    <input type="login" class="form-control" id="Login_usu" name="Login_usu" placeholder="Escolha um nome de usuário"" value="<?=$_SESSION["login"]?>">
  ...
  <div class="form-group">
    ...
    <input type="password" class="form-control" id="Senha_usu" name="Senha_usu" placeholder="Escolha uma senha">
                ...
                <div class="form-group">
                    ...
                    <input type="email" class="form-control" id="Email" name="Email" placeholder="Digite seu email" value="<?=$_SESSION['email']?>">
                </div>

                <div class="form-group">
                    <label for="Nome">Nome</label>
                    <input  class="form-control" id="Nome"  name="Nome" placeholder="Digite seu nome" value="<?=$_SESSION['nome']?>">
