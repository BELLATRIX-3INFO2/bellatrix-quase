        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mb30">
                <div data-aos="fade-up" class="team-block">
                    <div class="team-img">
                        <a href="#">
                            <img src="img/gaby.jpg" alt="" class="img-fluid">
                            <div class="social-media">
                                <a href="#" class="social-icon-box"><i class="fab fa-facebook-f"></i></a>
                                <br>
                                <a href="#" class="social-icon-box"><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mb30">
                <div data-aos="fade-up" class="team-block">
                    <div class="team-img">
                        <a href="#">
                            <img src="img/camila.jpg" alt="" class="img-fluid">
                            <div class="social-media">
                                <a href="#" class="social-icon-box"><i class="fab fa-facebook-f"></i></a>
                                <br>
                                <a href="#" class="social-icon-box"><i class="fab fa-twitter"></i></a>
            ...
            <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12 col-12 mb30">
                <div data-aos="fade-up" class="team-block">
                    <div class="team-img">
                        <a href="#">
                            <img src="img/miri.jpg" alt="" class="img-fluid">
                            <div class="social-media">
                                <a href="#" class="social-icon-box"><i class="fab fa-facebook-f"></i></a>
                                <br>
                                <a href="#" class="social-icon-box"><i class="fab fa-twitter"></i></a>
