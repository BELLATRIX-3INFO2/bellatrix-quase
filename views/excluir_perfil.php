    ...
    <script>
        $(document).ready(function () {
           $("#botao-apagar").click(function () {
               var pergunta = confirm("<?=$_SESSION['nome']?>, você quer mesmo apagar sua conta?");
               if (pergunta == true) {
                   window.location = "../controlador/usuario.php?acao=excluir"
               }
           })
        });
    </script>
    ...
    <div class="container">
        <div class="section-header">
            ...
            <div>
                ...
                <button class="btn btn-outline-success" id="botao-apagar">Excluir perfil</button>
