...
<div class="alert alert-danger" role="alert">
    <strong>Ops!</strong> Você tentou acessar uma página a qual não tem permissão, <a href="index.php" class="alert-link"> clique aqui para ter acesso a essa página</a>
</div>
